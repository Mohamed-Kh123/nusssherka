...
@section('content')
    ...
    <div class="container pb-3">
        ...
        @foreach ($categories as $category)
            <div class="modal fade" id="{{ _get($category, 'slug') }}" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <form class="form modal-content" id="form" action="{{ route('checkout.store') }}" method="post"
                        ...
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">{{ _get($category, 'name') }}</h1>
        ...
        @foreach ($bundles as $bundle)
            <div class="modal fade" id="{{ _get($bundle, 'slug') }}" data-bs-backdrop="static" data-bs-keyboard="false"
                 tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <form class="form modal-content" id="form" action="{{ route('checkout.store') }}" method="post"
                          enctype="multipart/form-data">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">{{ _get($bundle, 'name') }}</h1>
