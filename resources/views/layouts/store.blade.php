                                ...
                                <ul class="ht-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="language ht-language">
                                            <ul class="ht-setting-list">
                                                <li class="active"><a href="#"><img src="{{ asset('assets/front/images/menu/flag-icon/1.jpg') }}" alt="">English</a></li>
                                        </div>
                                    </li>
                            ...
                            <div class="hb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="{{ route('home') }}">باقات النص</a></li>
                                        <li><a href="{{ route('home') }}">عروض وخصومات</a></li>
                                        <li><a href="{{ route('home') }}">شركاء النجاح</a></li>
                                        <li><a href="{{ route('home') }}">نماذج الأعمال</a></li>
                                        <li><a href="{{ route('home') }}">شركاء النجاح</a></li>
                                        <li><a href="{{ route('about.index') }}">استفسر عنا</a></li>
                                        <li><a href="{{ route('contact.index') }}">تواصل معنا</a></li>
                                        <li><a href="{{ route('orders') }}">الطلبات</a></li>
                                    </ul>
                                </nav>
                            </div>
